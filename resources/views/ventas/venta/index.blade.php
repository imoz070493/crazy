			...
			<table id="example2" class="table table-striped table-bordered table-condensed table-hover">
				...
				<tr>
					...
					<td>
						...
						@endif
						@if($ven->estado=='2' && $ven->tipo_comprobante!= '03')
							<a href="{{asset('/enviar-correo')}}?tc={{$ven->tipo_comprobante}}&s={{$ven->serie_comprobante}}&c={{$ven->num_comprobante}}&m={{$ven->email}}"><button class="btn btn-success" title="Enviar Correo"><i class="fa fa-envelope"></i></button></a>
						@endif
