...
<script>
	...
	function calcular(x){
		...
		for(var i = 0; i < filas ; i++){
			$("#subtotal"+i).html(parseFloat(subtotal[i]).toFixed(2));
	...
	function agregar(){
		...
		if(idarticulo != "" && cantidad!="" && cantidad > 0 && descuento != "" && precio_venta != "") {
			if(parseInt(stock) >= parseInt(cantidad)){
				...
				var fila = '<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idarticulo[]" value="'+idarticulo+'">'+articulo+'</td><td><input id="cantidad'+cont+'" type="number" name="cantidad[]" value="'+cantidad+'" onblur="calcular('+cont+')"></td><td><input id="precio_venta'+cont+'" type="number" name="precio_venta[]" value="'+precio_venta+'" onblur="calcular('+cont+')"></td><td><input id="descuento'+cont+'" type="number" name="descuento[]" value="'+descuento+'" onblur="calcular('+cont+')"></td><td><label id="subtotal'+cont+'">'+subtotal[cont].toFixed(2)+'</label><input type="hidden" name="stockA[]" value="'+stock+'"></td></tr>';
